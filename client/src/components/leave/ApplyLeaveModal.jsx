...
const ApplyLeaveModal = ({ open, onClose, onSucess }) => {
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between p-6 pb-0">
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mt-0.5">Submit you leave request for approval</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="reason" rows={3} className="resize-none" placeholder="briefly describe why you need this leave..."/>
                    </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button disabled={loading} onClick={onClose} type="button" className="btn-primary flex-1 flex items-center justify-center gap-2">
