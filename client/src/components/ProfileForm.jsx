        ...
        <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="bio" defaultValue={initialData.bio || ""} placeholder="Write a brief bio..." disabled={initialData.isDeleted} className={`resize-none ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : ""}`}/>
